...
public class Level_02_Apply_BasePage_III extends BasePage{
	...
	public void TC_02_Register_Invalid_Email() {
		...
		sendkeyToElement(driver, "//input[@id='FirstName']", "automationFC");
		sendkeyToElement(driver, "//input[@id='LastName']", "Selenium23");
		sendkeyToElement(driver, "//input[@id='Email']", "13212424@##$$");
